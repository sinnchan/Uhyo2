using System;
using Src.Main.Domain.Entities;
using Src.Main.Presentation;
using UniRx;
using UnityEngine;
using UnityEngine.SceneManagement;

namespace Src.Presentation.View
{
    public sealed class ScenePresenter
    {
        private static readonly ScenePresenter _instance = new ScenePresenter();
